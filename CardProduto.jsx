...
const CardButton = styled.button`
  ...
  /* ── Estilização dinâmica ──────────────────────────────────────
     O prefixo $ torna $adicionado uma "transient prop":
     o styled-components a consome internamente para gerar o CSS
     e NÃO a repassa ao DOM, evitando o warning do React.
  ──────────────────────────────────────────────────────────────── */
  ${({ $adicionado }) =>
    $adicionado
      ? css`
    ...
    <Card>
      ...
      <CardBody>
        ...
        {/*
          ...
          A prop $adicionado (prefixo $) é uma transient prop:
          usada apenas pelo styled-component, nunca vai ao DOM.
        */}
